...
public class ActionBot {
	...
	public static WebElement waitForElementToBeDisplayed(RemoteWebDriver driver, final WebElement webElement,
			int timeOutPeriod) throws Exception {
		...
		try {
			...
			throw new Exception("\n ElementNotVisibleException in waitForElementToBeDisplayed Method While Finding "
					+ error + " => \n" + e, e);
		} catch (Exception e) {
			throw new Exception(
